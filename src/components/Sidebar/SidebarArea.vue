...
const menuGroups = ref([
  {
    ...
    menuItems: [
        ...
        children: [
          ...
          {label: 'Stocks', route: '/tables' },
          {label: 'Bons de commandes', route: '/' },
          {label: 'Transferts', route: '/' },
          {label: 'Carte Bancaire', route: '/' },
        ]
        },
        {
...
<template>
  ...
  >
    ...
    <div  class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
      <router-link to="/">
        <h1 class="text-center text-3xl text-white font-satoshi font-bold">Cadeau Parfait</h1>
      </router-link>
